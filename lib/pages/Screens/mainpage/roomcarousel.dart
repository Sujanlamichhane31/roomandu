...
import 'package:roomandu/model/constant.dart';
import 'package:roomandu/model/room.dart';
import 'package:roomandu/pages/roomdealdetails.dart';
import 'package:roomandu/pages/viewall.dart';
...
class RoomCarousel extends StatelessWidget {
  ...
  RoomCarousel(this.isDeal, @required this.title, @required this.subTitle,@required this.rooms);
